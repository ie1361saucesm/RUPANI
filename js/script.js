...
function renderSelector() {
  return '<div class="lw"><div class="lb">' +
    ...
    '<img src="img/rupani.png" alt="RUPANI" style="width:180px;height:auto;margin-bottom:10px">' +
    '</div>' +
...
function renderEstLogin() {
  ...
  html += '<div class="est-logo"><img src="img/rupani.png" alt="RUPANI" style="width:180px;height:auto;margin-bottom:10px">';
